...
export function Tips() {
  ...
  const tip = raw.replaceAll("OpenCode", Brand.productName()).replaceAll("opencode", Brand.cliName())
...
const TIPS = [
  "Run {highlight}valxos doctor{/highlight} in your shell for a Claude-compatibility report before your first test",
  "Use {highlight}/doctor{/highlight} on the VALXOS home screen to open the built-in compatibility snapshot",
