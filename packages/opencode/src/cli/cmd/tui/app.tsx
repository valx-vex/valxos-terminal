...
function useConservativeMacTerminalProfile() {
...
async function getTerminalBackgroundColor(): Promise<"dark" | "light"> {
  ...
  if (useConservativeMacTerminalProfile()) return "dark"
...
function rendererConfig(_config: TuiConfig.Info): CliRendererConfig {
  const conservativeMacTerminal = useConservativeMacTerminalProfile()
  ...
  return {
    ...
    gatherStats: false,
    exitOnCtrlC: false,
    screenMode: conservativeMacTerminal ? "main-screen" : "alternate-screen",
    useMouse: conservativeMacTerminal ? false : true,
    useKittyKeyboard: conservativeMacTerminal ? null : { events: process.platform === "win32" },
    autoFocus: false,
...
function App(props: { onSnapshot?: () => Promise<string[]> }) {
  ...
  return (
    ...
    >
      ...
      <Show when={!ready() && Brand.isValxos()}>
        <box width="100%" height="100%" alignItems="center">
          ...
          <box alignItems="center" gap={1}>
            ...
            <box backgroundColor={theme.backgroundPanel} paddingLeft={2} paddingRight={2} paddingTop={1} paddingBottom={1}>
              <text fg={theme.textMuted}>Launching VALXOS Terminal...</text>
            </box>
          </box>
          <box flexGrow={1} minHeight={0} />
        </box>
