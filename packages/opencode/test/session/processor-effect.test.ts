...
import { ClaudeCompat } from "../../src/compat/claude"
...
const claude = ClaudeCompat.layer.pipe(Layer.provideMerge(deps))
const env = Layer.mergeAll(TestLLMServer.layer, SessionProcessor.layer.pipe(Layer.provideMerge(claude), Layer.provideMerge(deps)))
