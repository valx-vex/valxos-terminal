export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من VALXOS",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من VALXOS، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق VALXOS",
  ...
  "desktop.cli.error.sidecarMissing": "ملف VALXOS CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
