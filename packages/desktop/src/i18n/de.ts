export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von VALXOS wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'valxos' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "VALXOS-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das VALXOS CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
