export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af VALXOS er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'valxos'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "VALXOS CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
