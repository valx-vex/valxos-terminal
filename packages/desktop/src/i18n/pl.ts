export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} VALXOS. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'valxos'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja VALXOS",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego VALXOS CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
