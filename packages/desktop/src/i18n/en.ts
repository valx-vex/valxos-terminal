export const dict = {
  ...
  "desktop.menu.help.documentation": "VALXOS Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of VALXOS has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'valxos' command.",
  ...
  "desktop.cli.error.sidecarMissing": "VALXOS CLI binary is missing. Try reinstalling the desktop app.",
