export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do VALXOS foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do VALXOS",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do VALXOS está ausente. Tente reinstalar o aplicativo de desktop.",
