export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av VALXOS er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "VALXOS Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "VALXOS CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
