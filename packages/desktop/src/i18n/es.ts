export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de VALXOS. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de VALXOS",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de VALXOS. Intenta reinstalar la aplicación de escritorio.",
