export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの VALXOS を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "VALXOS のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'valxos' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "VALXOS ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "VALXOS CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
