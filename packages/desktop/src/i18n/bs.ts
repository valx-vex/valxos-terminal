export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju VALXOS-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} VALXOS-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'valxos'.",
  ...
  "desktop.menu.help.documentation": "VALXOS Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka VALXOS CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
