export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'VALXOS",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'VALXOS a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'valxos'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'VALXOS",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI VALXOS est manquant. Essayez de réinstaller l'application de bureau.",
