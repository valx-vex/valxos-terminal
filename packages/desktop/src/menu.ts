    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://valxos.dev/docs"),
            text: t("desktop.menu.help.documentation"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/valxos"),
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/wearelegion1/valxos-terminal/issues/new?template=feature_request.yml"),
            text: t("desktop.menu.help.shareFeedback"),
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/wearelegion1/valxos-terminal/issues/new?template=bug_report.yml"),
